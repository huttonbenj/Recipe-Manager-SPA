...
9. Let cool for 2-3 minutes before slicing and serving.`,
      ...
      tags: ['italian', 'vegetarian', 'pizza', 'comfort-food', 'dinner'],
      cuisine: 'italian',
...
9. Serve immediately with crushed peanuts, lime wedges, and cilantro.`,
      ...
      tags: ['thai', 'asian', 'stir-fry', 'noodles', 'chicken', 'lunch', 'dinner'],
      cuisine: 'thai',
...
11. Season with salt and pepper. Serve immediately.`,
      ...
      servings: 4,
      difficulty: Difficulty.MEDIUM,
      tags: ['italian', 'vegetarian', 'rice', 'mushrooms', 'creamy', 'dinner'],
      cuisine: 'italian',
...
10. Garnish with fresh cilantro and serve with basmati rice or naan bread.`,
      ...
      servings: 4,
      difficulty: Difficulty.MEDIUM,
      tags: ['indian', 'chicken', 'curry', 'creamy', 'spicy', 'dinner'],
      cuisine: 'indian',
...
11. Garnish with crispy bacon and fresh parsley before serving.`,
      ...
      tags: ['french', 'chicken', 'wine', 'braised', 'classic', 'dinner'],
      cuisine: 'french',
...
9. Garnish with fresh cilantro and serve over couscous.`,
      ...
      servings: 6,
      difficulty: Difficulty.MEDIUM,
      tags: ['moroccan', 'lamb', 'apricots', 'slow-cooked', 'aromatic', 'dinner'],
      cuisine: 'moroccan',
      authorId: chefAisha.id,
...
9. Serve chilled or at room temperature.`,
      ...
      servings: 4,
      difficulty: Difficulty.EASY,
      tags: ['mediterranean', 'quinoa', 'healthy', 'vegetarian', 'fresh', 'lunch'],
...
8. Serve over jasmine rice with lime wedges.`,
      ...
      servings: 4,
      difficulty: Difficulty.MEDIUM,
      tags: ['thai', 'curry', 'coconut', 'spicy', 'chicken', 'lunch', 'dinner'],
      cuisine: 'thai',
      authorId: chefKenji.id,
...
10. Serve with extra BBQ sauce on the side.`,
      ...
      servings: 6,
      difficulty: Difficulty.EASY,
      tags: ['american', 'bbq', 'pork', 'sandwich', 'slow-cooked', 'lunch', 'dinner'],
      cuisine: 'american',
      authorId: homeChef.id,
...
9. Serve with soy sauce, wasabi, and pickled ginger.`,
      ...
      servings: 4,
      difficulty: Difficulty.MEDIUM,
      tags: ['japanese', 'sushi', 'seafood', 'fresh', 'healthy', 'lunch', 'appetizer'],
      cuisine: 'japanese',
      authorId: chefKenji.id,
...
8. Serve directly from the skillet with crusty bread.`,
      ...
      servings: 3,
      difficulty: Difficulty.EASY,
      tags: ['middle-eastern', 'eggs', 'tomato', 'brunch', 'vegetarian', 'breakfast'],
...
9. Garnish with green onions and serve over steamed rice.`,
      ...
      servings: 4,
      difficulty: Difficulty.EASY,
      tags: ['chinese', 'beef', 'stir-fry', 'quick', 'vegetables', 'lunch', 'dinner'],
      cuisine: 'chinese',
      authorId: chefKenji.id,
...
10. Slice and serve when completely cool.`,
      ...
      servings: 8,
      difficulty: Difficulty.EASY,
      tags: ['dessert', 'banana', 'bread', 'baking', 'sweet', 'breakfast', 'snack'],
      cuisine: 'american',
      authorId: homeChef.id,
  ...
  console.log(`   - Main Demo: demo@recipemanager.com`)
  console.log(`   - Chef Maria: maria@chef.com`)
  console.log(`   - Chef Kenji: kenji@culinary.com`)
  console.log(`   - Chef Aisha: aisha@spice.com`)
  console.log(`   - Chef Pierre: pierre@bistro.com`)
  console.log(`   - Home Chef: sarah@home.com`)
  console.log(`   Note: All demo accounts use secure hashed passwords`)
  console.log(``)
