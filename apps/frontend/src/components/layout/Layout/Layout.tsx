...
const Layout: React.FC = () => {
  ...
  const getMainClasses = () => {
    ...
    switch (location.pathname) {
      ...
      case '/login':
      case '/register':
        return `${baseClasses} flex items-center justify-center min-h-screen` // Auth pages
      default:
  ...
  return (
    <div className={`min-h-screen flex flex-col transition-theme duration-300 ${theme.isDark ? 'bg-gray-900' : 'bg-gray-50'
      }`}>
